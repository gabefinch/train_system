...
describe('Station') do
  ...
  describe('#save') do
    it('saves stations into database') do
      test_station1 = Station.new({:name => "Gresham", :id => nil})
      test_station1.save()
      test_station2 = Station.new({:name => "Ruby Junction", :id => nil})
      test_station2.save()
      test_station3 = Station.new({:name => "Epicodus", :id => nil})
      test_station3.save()
  ...
  describe("#id") do
    it('returns id from an instance of station') do
      test_station1 = Line.new({:name => "Blue", :id => nil})
      test_station1.save()
      test_station2 = Line.new({:name => "Red", :id => nil})
      test_station2.save()
      id = test_station2.id()
